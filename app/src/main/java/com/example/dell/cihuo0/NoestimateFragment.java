...
public class NoestimateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_noestimate, container, false);
        ...
        GridView gridView = (GridView)view.findViewById(R.id.Gv_noestimatefragment_contener);
